      ...
      <div className="mx-auto flex max-w-shell items-center justify-between gap-3 px-5 py-2.5 sm:px-8">
        ...
        <div className="relative" ref={pickerRef}>
          ...
          {open && (
            <ul
              role="listbox"
              className="absolute left-0 top-[calc(100%+10px)] z-50 max-h-72 w-56 overflow-auto rounded-lg border border-cream/10 bg-[#161616] py-1.5 shadow-2xl shadow-black/60"
            >
